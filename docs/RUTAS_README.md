...
El sistema utiliza una arquitectura robusta y escalable:

1. **Firebase Firestore**: Para almacenamiento en la nube y sincronización en tiempo real.
2. **IndexedDB (Dexie)**: Para almacenamiento local y funcionamiento 100% offline.
3. **Colecciones activas**: `routes`, `users`, `clientes`, `visitas`.
4. **Respaldo automático**: Sincronización inteligente de colas cuando hay conexión.

...
function SignageCaptureContent() {
  ...
  const handleNextPage = async () => {
    ...
    // 🔧 NO llamar a saveVisita() aquí - solo guardar en localStorage
    // Los datos se guardarán completamente en reportes-finales al final de la ruta
    console.log(
      "💾 Guardando datos de señalización en localStorage (offline-ready)..."
    );

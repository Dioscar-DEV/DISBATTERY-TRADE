  ...
  useEffect(() => {
    ...
    if (!datos) {
      toast({
        variant: 'destructive',
        title: 'Error',
        description: 'No se encontraron datos del formulario. Regresando al inicio.',
      });
      router.push('/');
      return;
    }
    ...
    if (datosParseados.huboVentasShell !== true && datosParseados.huboVentasQualid !== true) {
  ...
  const handleContinuar = async () => {
    ...
    try {
      ...
      if (datosFormulario.huboVentasShell === true) {
        ...
        if (shellVacio) {
          toast({
            ...
            description: 'Por favor, complete al menos un campo de ventas SHELL.',
          });
          return;
        }
      }
      ...
      if (datosFormulario.huboVentasQualid === true) {
        const qualidVacio = Object.values(ventasQualid).every(val => val === '');
        if (qualidVacio) {
          toast({
            variant: 'destructive',
            title: 'Ventas QUALID Requeridas',
            description: 'Por favor, complete al menos un campo de ventas QUALID.',
          });
          return;
        }
      }
      ...
      const datosCompletos = {
        ...datosFormulario,
        ventasShellDetalladas: datosFormulario.huboVentasShell === true ? ventasShell : null,
        ...
        <CardContent className="space-y-6">
          ...
          {mostrarVentasShell && (
            <div className="space-y-4 border rounded-lg p-4 bg-yellow-50">
              <Label className="text-lg font-semibold">Reporte de ventas productos SHELL</Label>
              <p className="text-sm text-muted-foreground">
                Registra las cantidades en litros de los productos Shell por familia de productos vendidos durante el impulso o evento.
              </p>

              <div className="grid gap-4">
                <div className="space-y-2">
                  <Label htmlFor="shell-advance">Total en litros de SHELL ADVANCE vendidos: *</Label>
                  <p className="text-xs text-muted-foreground">Responde únicamente con un valor numérico, 0-999</p>
                  <Input
                    id="shell-advance"
                    type="number"
                    min="0"
                    ...
                    onChange={(e) => handleVentasShellChange('advance', e.target.value)}
                    disabled={isSyncing}
                    placeholder="0"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="shell-hx5">Total en litros de SHELL HELIX HX5 vendidos: *</Label>
                  <p className="text-xs text-muted-foreground">Responde únicamente con un valor numérico, 0-999</p>
                  <Input
                    id="shell-hx5"
                    type="number"
                    ...
                    onChange={(e) => handleVentasShellChange('helixHX5', e.target.value)}
                    disabled={isSyncing}
                    placeholder="0"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="shell-hx7">Total en litros de SHELL HELIX HX7 vendidos: *</Label>
                  <p className="text-xs text-muted-foreground">Responde únicamente con un valor numérico, 0-999</p>
                  <Input
                    id="shell-hx7"
                    type="number"
                    ...
                    onChange={(e) => handleVentasShellChange('helixHX7', e.target.value)}
                    disabled={isSyncing}
                    placeholder="0"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="shell-hx8">Total en litros de SHELL HELIX HX8 vendidos: *</Label>
                  <p className="text-xs text-muted-foreground">Responde únicamente con un valor numérico, 0-999</p>
                  <Input
                    id="shell-hx8"
                    type="number"
                    ...
                    onChange={(e) => handleVentasShellChange('helixHX8', e.target.value)}
                    disabled={isSyncing}
                    placeholder="0"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="shell-ultra">Total en litros de SHELL HELIX ULTRA vendidos: *</Label>
                  <p className="text-xs text-muted-foreground">Responde únicamente con un valor numérico, 0-999</p>
                  <Input
                    id="shell-ultra"
                    type="number"
                    ...
                    onChange={(e) => handleVentasShellChange('helixUltra', e.target.value)}
                    disabled={isSyncing}
                    placeholder="0"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="shell-rimula">Total en litros de SHELL RIMULA vendidos: *</Label>
                  <p className="text-xs text-muted-foreground">Responde únicamente con un valor numérico, 0-999</p>
                  <Input
                    id="shell-rimula"
                    type="number"
                    ...
                    onChange={(e) => handleVentasShellChange('rimula', e.target.value)}
                    disabled={isSyncing}
                    placeholder="0"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="shell-spirax">Total en litros de SHELL SPIRAX vendidos: *</Label>
                  <p className="text-xs text-muted-foreground">Responde únicamente con un valor numérico, 0-999</p>
                  <Input
                    id="shell-spirax"
                    type="number"
                    ...
                    onChange={(e) => handleVentasShellChange('spirax', e.target.value)}
                    disabled={isSyncing}
                    placeholder="0"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="shell-gadus">Total en cartuchos de SHELL GADUS vendidos: *</Label>
                  <p className="text-xs text-muted-foreground">Responde únicamente con un valor numérico, 0-999</p>
                  <Input
                    id="shell-gadus"
                    type="number"
                ...
                <div className="space-y-2">
                  <Label htmlFor="shell-otros">Total en litros de OTROS vendidos: *</Label>
                  <p className="text-xs text-muted-foreground">OTROS representa productos como: Nautilus, Hydraulic, Tellus, etc. Responde únicamente con un valor numérico, 0-999</p>
                  <Input
                    id="shell-otros"
                    type="number"
                    min="0"
          ...
          {mostrarVentasQualid && (
            <div className="space-y-4 border rounded-lg p-4 bg-blue-50">
              <Label className="text-lg font-semibold">Reporte de ventas productos QUALID</Label>
              <p className="text-sm text-muted-foreground">
                Registra las cantidades en litros y en unidades de los productos Qualid vendidos durante el impulso o evento.
              </p>

              <div className="grid gap-4">
                <div className="space-y-2">
                  <Label htmlFor="qualid-fluidos">Total en litros de QUALID FLUIDOS vendidos: *</Label>
                  <p className="text-xs text-muted-foreground">Responde únicamente con un valor numérico, 0-999</p>
                  <Input
                    id="qualid-fluidos"
                    type="number"
                    ...
                    onChange={(e) => handleVentasQualidChange('fluidos', e.target.value)}
                    disabled={isSyncing}
                    placeholder="0"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="qualid-spray">Total en unidades de QUALID SPRAY vendido: *</Label>
                  <p className="text-xs text-muted-foreground">Responde únicamente con un valor numérico, 0-999</p>
                  <Input
                    id="qualid-spray"
                    type="number"
                    ...
                    onChange={(e) => handleVentasQualidChange('spray', e.target.value)}
                    disabled={isSyncing}
                    placeholder="0"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="qualid-filtro">Total en unidades de QUALID FILTRO AUTOMOTRIZ vendidos: *</Label>
                  <p className="text-xs text-muted-foreground">Responde únicamente con un valor numérico, 0-999</p>
                  <Input
                    id="qualid-filtro"
                    type="number"
                    ...
                    onChange={(e) => handleVentasQualidChange('filtroAutomotriz', e.target.value)}
                    disabled={isSyncing}
                    placeholder="0"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="qualid-cauchos">Total en unidades de CAUCHOS QUALID vendidos: *</Label>
                  <p className="text-xs text-muted-foreground">Responde únicamente con un valor numérico, 0-999</p>
                  <Input
                    id="qualid-cauchos"
                    type="number"

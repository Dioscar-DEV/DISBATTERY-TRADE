...
// GPS removido para funcionamiento offline puro
...
function VisitCaptureContent() {
  ...
  // GPS removido
  const locationDisplay = "Ubicación no disponible en modo offline";
...
function useVisitFlow({
  ...
  const handleRedirection = useCallback(
    async (visitType: VisitType) => {
      ...
      try {
        // GPS removido: solo guardar tipo de visita

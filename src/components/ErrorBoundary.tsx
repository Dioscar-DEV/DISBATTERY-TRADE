...
class ErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    ...
    if (
      ...
      msg.includes("chunk no longer available")
    ) {
      console.warn("ErrorBoundary: ChunkLoadError detected, clearing caches and reloading...");
      if ("caches" in window) {
      ...
      return; // Don't update state, we're reloading
    }

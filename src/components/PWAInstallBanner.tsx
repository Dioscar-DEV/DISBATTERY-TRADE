...
export function PWAInstallBanner() {
  ...
  useEffect(() => {
    ...
    const shouldShow =
      !bannerDismissed || Date.now() - dismissedTime > sixHoursInMs;
    ...
    console.log("🎯 [PWA Banner] Estado del banner:", {
      ...
      sixHoursInMs,
      shouldShow,
      isInstalled: (window as Window).matchMedia("(display-mode: standalone)")
        .matches,
    });
    ...
    if (shouldShow) {
      ...
      console.log(
        "🎯 [PWA Banner] Banner no se muestra porque fue cerrado recientemente"
      );
    }
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 animate-in slide-in-from-top-4 duration-500">
      <div className="bg-gradient-to-r from-brand-blue to-brand-red shadow-lg">
        <div className="px-4 py-2">
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              <Button
                onClick={
                  canInstall ? handleInstallClick : handleOpenInstallPage
                }
                size="sm"
                variant="secondary"

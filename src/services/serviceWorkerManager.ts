...
class ServiceWorkerManager {
  ...
  // IMPORTANT: Must use /sw.js (workbox-generated by next-pwa) to preserve
  // precached chunks for offline. Never use sw-combined.js as it replaces
  // workbox and destroys the chunk cache on activation.
  private readonly DEFAULT_SW = "/sw.js";
  ...
  /**
   * Returns the Service Worker URL to register.
   * Always uses /sw.js (workbox-generated by next-pwa) to keep precached chunks.
   */

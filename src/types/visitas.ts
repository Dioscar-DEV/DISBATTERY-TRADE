...
export const mapearParaSheet = (visita: Visita): Record<string, any> => {
  ...
  if (visita.tipoVisita === "Merchandising") {
    ...
    return {
      ...base,
      "¿El cliente posee señalización?": resp.clientePoseeSeñalizacion
        ? "Sí"
        : "No",
      ...
      "¿El cliente tiene STICKER PUNTO DE VENTA AUTORIZADO SHELL?":
        resp.clienteTieneStickerShell ? "Sí" : "No",
      "¿Colocaste STICKER PUNTO DE VENTA AUTORIZADO SHELL?":
        resp.colocasteStickerShell ? "Sí" : "No",
      "Foto del STICKER PUNTO DE VENTA AUTORIZADO SHELL:":
        resp.fotoStickerShell || "",
      "Total de CENEFAS SHELL colocadas:": resp.totalCenefasShell,
      "Total de PAPEL BOBINA SHELL colocado en metros:":
        resp.totalPapelBobinaShell,
      "Total de STICKERS SHELL CAMBIO DE LUBRICANTE entregados:":
        resp.totalStickersShellCambio,
      "Total de AMBIENTADORES SHELL PARA VEHÍCULO entregados:":
        resp.totalAmbientadoresShell,
      "Total de BOLSAS SHELL PARA CARRO entregadas:": resp.totalBolsasShell,
      "¿El cliente tiene EXHIBIDORES SHELL?": resp.clienteTieneExhibidoresShell
        ? "Sí"
        : "No",
      "De tener EXHIBIDORES SHELL, adjunta aquí la foto:":
        resp.fotoExhibidoresShell || "",

      // Afiches Shell
      "¿Cuáles y cuantos AFICHES SHELL? [AFICHES CAMPAÑA FERRARI 2023]":
        resp.afichesFerrari2023,
      "¿Cuáles y cuantos AFICHES SHELL? [AFICHES CAMPAÑA HX8]": resp.afichesHX8,
      "¿Cuáles y cuantos AFICHES SHELL? [AFICHES CAMPAÑA PRODUCTOS PREMIUM 2024]":
        resp.afichesProductosPremium2024,
      "¿Cuáles y cuantos AFICHES SHELL? [AFICHES CAMPAÑA SHELL FAMILIA 2023]":
        resp.afichesShellFamilia2023,
      "¿Cuáles y cuantos AFICHES SHELL? [AFICHES CAMPAÑA SHELL HX7 10W-40]":
        resp.afichesShellHX7,
      "¿Cuáles y cuantos AFICHES SHELL? [AFICHES CAMPAÑA TABLA DE APLICACION SHELL]":
        resp.afichesTablaAplicacionShell,
      "¿Cuáles y cuantos AFICHES SHELL? [AFICHE CAMPAÑA SHELL GADUS 2021]":
        resp.aficheShellGadus2021,
      "¿Cuáles y cuantos AFICHES SHELL? [AFICHE SHELL HELIX]":
        resp.aficheShellHelix,
      "¿Cuáles y cuantos AFICHES SHELL? [AFICHE SHELL RIMULA]":
        resp.aficheShellRimula,
      "¿Cuáles y cuantos AFICHES SHELL? [AFICHE SHELL ADVANCE]":
        resp.aficheShellAdvance,
      "¿Cuáles y cuantos AFICHES SHELL? [AFICHE SHELL 5W-30]":
        resp.aficheShell5W30,
      "Fotos de los AFICHES SHELL colocados:": resp.fotosAfichesShell || "",

      // Banderines
      "¿Colocaste TIRA DE BANDERINES SHELL?": resp.colocasteBanderinesShell
        ? "Sí"
        : "No",
      "Total de TIRA DE BANDERINES SHELL colocadas:": resp.totalBanderinesShell,
      "Fotos de los BANDERINES SHELL colocados:":
        resp.fotosBanderinesShell || "",

      // Aviso Acrílico
      "¿El cliente tiene AVISO ACRÍLICO PARA EXTERIORES SHELL?":
        resp.clienteTieneAvisoAcrilicoShell ? "Sí" : "No",
      "Foto del AVISO ACRÍLICO PARA EXTERIORES SHELL colocado:":
        resp.fotoAvisoAcrilicoShell || "",
      ...
      // Afiches Qualid
      "¿Cuáles y cuantos AFICHES QUALID? [AFICHES CAMPAÑA FILTROS Y FLUIDOS 2024]":
        resp.afiches_FiltrosFluidos2024,
      "¿Cuáles y cuantos AFICHES QUALID? [AFICHES CAMPAÑA QUALID CAUCHO 2023]":
        resp.afichesQualidCaucho2023,
      "¿Cuáles y cuantos AFICHES QUALID? [AFICHES CAMPAÑA QUALID CAUCHO 2024]":
        resp.afichesQualidCaucho2024,
      "¿Cuáles y cuantos AFICHES QUALID? [AFICHES CAMPAÑA QUALID CUIDADO AUTOMOTRIZ 2022]":
        resp.afichesQualidCuidadoAutomotriz2022,
      "¿Cuáles y cuantos AFICHES QUALID? [AFICHES CAMPAÑA QUALID FF 2022]":
        resp.afichesQualidFF2022,
      "¿Cuáles y cuantos AFICHES QUALID? [AFICHES CAMPAÑA QUALID FILTROS 2022]":
        resp.afichesQualidFiltros2022,
      "¿Cuáles y cuantos AFICHES QUALID? [AFICHES CAMPAÑA QUALID MANTENIMIENTO 2022]":
        resp.afichesQualidMantenimiento2022,
      "¿Cuáles y cuantos AFICHES QUALID? [AFICHES CAMPAÑA QUALID TABLA CROSS REFERENCE SERVICIO PESADO 2024]":
        resp.afichesQualidTablaCrossReference2024,
      "¿Cuáles y cuantos AFICHES QUALID? [AFICHES CAMPAÑA QUALID TABLA DE APLICACIÓN]":
        resp.afichesQualidTablaAplicacion,
      "¿Cuáles y cuantos AFICHES QUALID? [AFICHES CAMPAÑA QUALID TABLA DE FILTRO AUTOMOTRIZ 2024]":
        resp.afichesQualidTablaFiltroAutomotriz2024,
      "¿Cuáles y cuantos AFICHES QUALID? [AFICHE QUALID FILTROS AUTOMOTRIZ]":
        resp.aficheQualidFiltrosAutomotriz,
      "¿Cuáles y cuantos AFICHES QUALID? [AFICHE QUALID FAMILY CAR CARE]":
        resp.aficheQualidFamilyCarCare,
      "Fotos de los AFICHES QUALID colocados:": resp.fotosAfichesQualid || "",

      // Exhibidores Qualid
      "¿Colocaste EXHIBIDORES DE CAUCHOS QUALID?":
        resp.colocasteExhibidoresCauchosQualid ? "Sí" : "No",
      "Total de EXHIBIDOR DE CAUCHO PEQUEÑO colocado:":
        resp.totalExhibidorCauchoPequeño,
      "Total de EXHIBIDORES DE CAUCHO GRANDE colocado:":
        resp.totalExhibidorCauchoGrande,
      "Foto de EXHIBIDORES DE CAUCHOS QUALID colocados:":
        resp.fotoExhibidoresCauchosQualid || "",
